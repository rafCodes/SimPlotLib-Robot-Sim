...
class RoadNodeKDTree(KDTree):
    ...
    def __init__(self, data):
        ...
        """
        self._data = data
        self._coordinates = np.asarray(self._projectTo2D(self._data))
        super(RoadNodeKDTree, self).__init__(self._coordinates)
    ...
    def getClosestForwardNode(self, point, heading):
        ...
        """
        heading = heading - 6.283185307179586 if heading > 6.283185307179586 else heading
        ...
        for i in indices:
            ...
            if vector[0] == 0:
                if vector[1] == 0:
                    ...
                    angleFromPoint = 1.5707963267948966 if vector[1] > 0 else - 1.57079
            else:
                angleFromPoint = math.atan2(vector[1],vector[0])
            headingFromPoint = 1.5707963267948966 - heading - angleFromPoint
            if (-1.5707963267948966 <= headingFromPoint <= 1.5707963267948966):
                return self._data[i]
